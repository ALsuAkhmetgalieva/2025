...
def test_post_avia(): #Билет в 1 сторону, 1 взрослый
    api = ProjectAPI(base_url="https://auth.avs.io/", token="")
    search_data = {
    "search": {
    ...
    result = api.post_avia(data=search_data)
...
@allure.description("Поиск авиабилетов без пассажиров.")
